...
let ufos = [];
let animationId; // We need this to stop the animation later
const start = Date.now();

// We must export this function so index.html can call it
export function init(container) {
    ...
    // Add to container (Passed from index.html)
...
function animate() {
    // Capture the ID so we can stop it later
...
// REQUIRED: This tells index.html how to clean up when you switch backgrounds
