...
function animate() {
    ...
    // *** SETTINGS: CHANGE SPEED HERE ***
    const speed = 1.5; // Was 5.0 (Lower number = Slower)
    const rotationSpeed = 0.002; // Was 0.01 (Slower twist)
...
// Added the Crash Fix here just in case you switch backgrounds
